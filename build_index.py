...
'.assist_mode_badge{font-size:11px;color:#a5b4fc;text-align:center;user-select:none}\n'
...
'.assist_goal_row{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:8px}\n'
'.assist_goal_row label{font-size:12px;color:#d1d5db}\n'
'.assist_goal_row select{flex:1;max-width:260px}\n'
'.assist_thread_row{display:flex;gap:8px;align-items:center;margin-bottom:8px}\n'
'.assist_thread_row select{flex:1;min-width:140px}\n'
'.assist_thread_row button{white-space:nowrap}\n'
'#assist_thread_hint{min-height:14px;color:#93c5fd;font-size:11px;margin-bottom:8px}\n'
